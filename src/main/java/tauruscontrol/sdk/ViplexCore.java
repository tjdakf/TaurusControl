...
public interface ViplexCore extends Library {
    ...
    void nvGetProgramPageDurationAsync(String data, CallBack callBack);
    void nvVedioFastForwardAsync(String data, CallBack callBack);
    void nvProgramRenameAsync(String data, CallBack callBack);
    void nvPPTProgramPageTurnAsync(String data, CallBack callBack);
    void nvGetFileFromTerminalAsync(String data, CallBack callBack);
    void nvPublicModuleUpdateOSUseOSSAsync(String data, CallBack callBack);
    void nvStopUpdateFiterProgramAsync(String data, CallBack callBack);
    void nvStopInterProgramAsync(String data, CallBack callBack);
    void nvGetInterProgramInfoAsync(String data, CallBack callBack);
    void nvStartTransferInterProgramAsync(String data, CallBack callBack);
    ...
    void nvUpdateTemplateInterProgramAsync(String data, CallBack callBack);
    void nvSendTemplateInterProgramAsync(String data, CallBack callBack);
    ...
    void nvStartTransferProgramUseOSSAsync(String data, CallBack callBack);
    ...
    void nvMakeProgramToZipAsync(String data, CallBack callBack);
    ...
    void nvCreateInterProgramAsync(String data, CallBack callBack);
    ...
    void nvGetPlayWindowSiteAsync(String data, CallBack callBack);
    void nvSetPlayWindowSiteAsync(String data, CallBack callBack);
    ...
    void nvSendScreenScrAsync(String data, CallBack callBack);
